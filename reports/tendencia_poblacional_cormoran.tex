...
\begin{table}[H]
  \centering
  \caption{Tasa de crecimiento para las colonias de cormorán orejón en el pacífico para las que no observaron tendencias globales aparentes. El \textit{p-value} calculado no tuvo significancia en las dos hipótesis nula probadas: de una población en crecimiento, ni de una población en decrecimiento.}
   \pgfplotstabletypeset[
      string type,
